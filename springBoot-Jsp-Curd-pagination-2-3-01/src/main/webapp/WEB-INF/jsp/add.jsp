						...
						<form th:action="@{/save_products}" method="post">
							...
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Enter
									...
									id="exampleInputEmail1" aria-describedby="emailHelp" name="productName">
							...
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Enter
									...
									id="exampleInputEmail1" aria-describedby="emailHelp" name="decription">
							...
							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Quantity
									...
									id="exampleInputEmail1" aria-describedby="emailHelp" name="quantity">
